# Deployment Guide - Panneels Martijn 3B2
...
6. Om te valideren of server1 alle functionaliteiten heeft kan je het `C:\Users\Public\shared_folder\Server1\valideerS1.ps1` uit voeren en de output bekijken.
...
4. Ga in de powershell env: `powershell`
5. Voer op de VM `C:\Users\Public\shared_folder\Server2\setupS2-p2.ps1` uit.
6. Om te valideren of server2 alle functionaliteiten heeft kan je het `C:\Users\Public\shared_folder\Server2\valideerS2.ps1` uit voeren en de output bekijken.
...
6. Om te valideren of de client alle functionaliteiten heeft kan je het `C:\Users\Public\shared_folder\Client\valideerC.ps1` uit voeren en de output bekijken.
...
11. ![WebEnrolment](image.png)

## Reflectie

### Wat heb je geleerd uit dit deel van het project?

In dit deel van het project heb ik geleerd hoe krachtig Powershell en scripting in het algemeen is. Ik heb ook een beter idee gekregen wat er allemaal nodig is om een windows server omgeving op te zetten. Het was ook een goede oefening om eens te denken over de chronologie en de dependencies van de configuraties en de systemen onderling.

### Wat zou je in de toekomst anders doen?

Meer gebruik maken van de officiële documentatie van Microsoft zelf. Er staat zeer veel in de officiële documentatie dat je kan gebruiken om deze opdracht te volbrengen. Ik had wat meer moeten doorklikken op sommige pagina's om de juiste powershell commando's te vinden.

### Aan welke zaken heb je (te) veel tijd verloren?

Ik denk dat ik veel tijd heb verloren door teveel mijn scripts te willen runnen. Ik had meer commando's eerst handmatig moeten uitvoeren vooralleer ik deze in mijn scripts ging schrijven. Door slim gebruik te maken van snapshots is de verloren tijd nog wel goed mee gevallen.
